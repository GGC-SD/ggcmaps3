...
function openTravelMenu() {
    debug.group("Open Travel Menu");
    // The menu itself
    var menu = document.getElementsByClassName('travel')[0];
    // The content overlay
    var content = document.getElementsByClassName('content-disable')[0];

    if (menu.className === 'travel') {
        menu.classList.add('travel-active');
        // Disables the content of the page until the menu is closed
        content.classList.add('active');
    }
    debug.end();
...
function closeTravelMenu() {
    debug.group("Close Travel Menu");
    // The menu itself
    var menu = document.getElementsByClassName('travel')[0];
    // The content overlay
    var content = document.getElementsByClassName('content-disable')[0];

    if (menu.className === 'travel travel-active') {
        menu.classList.remove('travel-active');
        // Enables the content of the page again
        content.classList.remove('active');
    }
